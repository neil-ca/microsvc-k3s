...
mongo_video = PyMongo(server, uri="mongodb://linuxbox:27017/videos")
mongo_mp3 = PyMongo(server, uri="mongodb://linuxbox:27017/mp3s")
fs_video = GridFS(mongo_video.db)
fs_mp3 = GridFS(mongo_mp3.db)
